...
export const DICE_RESULT_DISMISS_MS      = 1700 // ms from dice signal to attack fire: 1200ms roll + 500ms hold; tap-to-skip cuts this short
export const CLASH_ANNOUNCE_MS           = 1500 // ms clash-winner log is shown before phase advances
export const AI_THINKING_MIN_MS          = 3000 // min ms AI "deliberates" before revealing target
export const AI_THINKING_MAX_MS          = 5000 // max ms AI "deliberates" before revealing target
export const AI_INPUT_MIN_MS             = 2000 // min ms between target reveal and attack execution
